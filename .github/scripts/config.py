...
# FIX: Đưa tintColor vào config thay vì hardcode trong engine
TINT_COLOR = "848ef9"
...
# FIX: Gom 2 file database vào cùng thư mục wiki/ cho nhất quán
# Cấu trúc: main(root)/repo/depictions/metadata/wiki/wikiipa.json
#           main(root)/repo/depictions/metadata/wiki/wikideb.json
WIKI_DIR = os.path.join(DEPICTION_DIR, "wiki")
FEATHER_DATABASE = os.path.join(WIKI_DIR, "wikiipa.json")
SILEO_DATABASE = os.path.join(WIKI_DIR, "wikideb.json")
...
# FIX: Tweak description cũng gom vào cùng cụm (giống IPA)
...
# --- Tạo thư mục tự động ---
for d in [APPS_INPUT_DIR, DEBS_INPUT_DIR, DESC_DIR, TWEAK_DESC_DIR, DEPICTION_DIR, WIKI_DIR, ICON_DIR, IMG_DIR, DEFAULT_DIR, REPO_OUTPUT_DIR]:
