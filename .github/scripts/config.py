...
REPO_NAME = "Kyic storage"
SOURCE_IDENTIFIER = "com.kyic.stor"
# tintColor config 
TINT_COLOR = "848ef9"

# Cấu trúc data: main(root)/repo/data/…
...
# Thư mục riêng cho HTML do views.py sinh ra (gom gọn, tách khỏi JSON/data)
# main(root)/repo/html/…  (JS vẫn giữ nội tuyến trong từng file HTML)
REPO_HTML_DIR = os.path.join(REPO_OUTPUT_DIR, "html")

# --- Vùng đệm và cấu trúc nhóm (wiki data) ---
...
# --- Xắp xếp vùng đện wiki thành phẩm  ---
# Vị tri đọc vào đầu vào các app: Feather/Sileo
APPS_JSON_PATH = os.path.join(REPO_ROOT, "repo/apps.json")
SILEO_JSON_PATH = os.path.join(REPO_ROOT, "repo/debs.json")
...
DEFAULT_BANNER = f"{RAW_URL}{DEFAULT_DIR_NAME}/Kyic_banner.webp"
...
# --- Tạo thư mục tự động ---
for d in [APPS_INPUT_DIR, DEBS_INPUT_DIR, DYLIBS_INPUT_DIR, DESC_DIR, TWEAK_DESC_DIR, DYLIB_DESC_DIR, DEPICTION_DIR, WIKI_DIR, ICON_DIR, IMG_DIR, DEFAULT_DIR, REPO_OUTPUT_DIR, REPO_HTML_DIR]:
